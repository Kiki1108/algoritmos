...
def main():
    datos_sumas = [n*10000 for n in range(100)]
    datos_potencias = [n*1000 for n in range(100)]
    datos_factorial = [n*100 for n in range(100)]
    #datos_factorial_recursiva = [n*1 for n in range(50)]

    lista_sumas = [0 for i in range(100)]
    lista_potencias = [0 for i in range(100)]
    lista_factorial = [0 for i in range(100)]
    ...
    for j in range(10):
        for i in range(100):
            lista_potencias[i] = lista_potencias[i] + potencia(2, datos_potencias[i])
    ...
    for j in range(10):
        for i in range(100):
            lista_factorial[i] = lista_factorial[i] + factorial(datos_factorial[i])
